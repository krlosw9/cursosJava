...
public class UIMenu {
    ...
    private static void authUser(int userType){
        ...
        doctors.add(new Doctor("Alejandro Martínez", "alejandro@mail.com", "Pediadria"));
        doctors.add(new Doctor("Karen Sosa", "kare@mail.com", "Nutricion"));
        doctors.add(new Doctor("Rocío Gómez", "rocio@mail.com", "Urgencias"));
